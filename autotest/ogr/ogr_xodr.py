...
def check_feat_def_road_signal(layer, dissolve_tin: bool):
    if not dissolve_tin:
        ...
        assert layer.GetGeomType() == ogr.wkbPoint, "bad layer geometry type"
