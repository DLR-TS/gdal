...
CubicPolynomial CubicPolynomial::derivative()
{
    double dA   =   b;
    double dB   =   c * 2;
    double dC   =   d * 3;
    ...
    CubicPolynomial dervPoly(dA,dB,dC,dD);
    
    return dervPoly;
}

double
CubicPolynomial::getD () const
{
  return d;
}

double
CubicPolynomial::getC () const
{
  return c;
}

double
CubicPolynomial::getB () const
{
  return b;
}

double
CubicPolynomial::getA () const
{
  return a;
}
