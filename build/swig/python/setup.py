...
is_standalone_build = not os.path.exists('/home/gdal/build/swig/python')

if is_standalone_build:
    include_dirs = []
    library_dirs = []
else:
    include_dirs = ['/home/gdal/build/port', '/home/gdal/port', '/home/gdal/build/gcore', '/home/gdal/gcore', '/home/gdal/alg', '/home/gdal/ogr/', '/home/gdal/ogr/ogrsf_frmts', '/home/gdal/gnm', '/home/gdal/apps']
    library_dirs = ['/home/gdal/build']
libraries = ['gdal']
