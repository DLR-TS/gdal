...
set(INSTALL_DIR "$ENV{DESTDIR}/usr/local/share/bash-completion/completions")

file(MAKE_DIRECTORY "${INSTALL_DIR}")
message(STATUS "Installing ${INSTALL_DIR}/gdalinfo")
configure_file("/home/gdal/scripts/gdal-bash-completion.sh" "${INSTALL_DIR}/gdalinfo" COPYONLY)
...
foreach (program IN LISTS PROGRAMS)
  ...
  file(APPEND /home/gdal/build/install_manifest_extra.txt "${INSTALL_DIR}/${program}\n")
endforeach ()
